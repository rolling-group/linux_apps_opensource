 ...
 * @file rolling_helper_cid.h
 * @author qifeng.liu@rollingwireless.com (liuqifeng)
 * @brief rolling helper command id file
 * @version 1.0
 * @date 2025-11-23
 *
 *
...
#ifndef _ROLLING_HELPER_CID_H_
#define _ROLLING_HELPER_CID_H_
...
typedef enum
{
    ...
    FLASH_FW_EDL,
    CHECK_SUPPORT_LIST,
    REQ_RECOVERY_MODULE = FLASH_FW_EDL,
    REPORT_MODULE_STATE = GET_PORT_STATE,
